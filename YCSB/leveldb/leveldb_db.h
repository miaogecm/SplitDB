...
namespace ycsbc {
  ...
  class LeveldbDB : public DB {
   public:
    ...
    Status
    Read(const std::string &table, const std::string &key,
   ...
   private:
    ...
    void GetOptions_(const utils::Properties &props, leveldb::Options *opt);
    static void
    SerializeRow_(const std::vector<Field> &values, std::string *data);
    void
    DeserializeRowFilter_(std::vector<Field> *values, const std::string &data,
                          const std::vector<std::string> &fields);
    void DeserializeRow(std::vector<Field> *values, const std::string &data);
    std::string
    BuildCompKey(const std::string &key, const std::string &field_name);
    ...
    Status (LeveldbDB::*method_read_)(const std::string &, const std::string &,
                                      ...
                                      std::vector<Field> &);
    Status (LeveldbDB::*method_scan_)(const std::string &, const std::string &,
                                      int, const std::vector<std::string> *,
                                      std::vector<std::vector<Field>> &);
    Status (LeveldbDB::*method_update_)(const std::string &,
                                        const std::string &,
                                        std::vector<Field> &);
    Status (LeveldbDB::*method_insert_)(const std::string &,
                                        const std::string &,
                                        std::vector<Field> &);
    Status (LeveldbDB::*method_delete_)(const std::string &,
                                        const std::string &);
