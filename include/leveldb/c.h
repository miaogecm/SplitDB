...
extern "C"
{
  ...
  LEVELDB_EXPORT void
  leveldb_compact_range(leveldb_t *db, const char *start_key,
  ...
  LEVELDB_EXPORT void
  leveldb_writebatch_put(leveldb_writebatch_t *, const char *key, size_t klen,
  ...
  LEVELDB_EXPORT void
  leveldb_options_set_filter_policy(leveldb_options_t *,
  ...
  LEVELDB_EXPORT void
  leveldb_options_set_block_size(leveldb_options_t *, size_t);
  LEVELDB_EXPORT void
