...
namespace leveldb {
  ...
  class LEVELDB_EXPORT Env {
   public:
    ...
    virtual Status
    NewSequentialFile(const std::string &fname, SequentialFile **result) = 0;
    ...
    // The returned file will only be accessed by one thread at a time.
    virtual Status
    NewWritableFile(const std::string &fname, WritableFile **result) = 0;
    ...
    virtual Status
    NewAppendableFile(const std::string &fname, WritableFile **result);
    ...
    virtual Status
    GetChildren(const std::string &dir, std::vector<std::string> *result) = 0;
    ...
    virtual Status
    RenameFile(const std::string &src, const std::string &target) = 0;
    ...
    // serialized.
    virtual auto
    Schedule(void (*function)(void *arg), void *arg) -> std::thread * = 0;
  ...
  class LEVELDB_EXPORT RandomAccessFile {
   public:
    ...
    virtual Status
    Read(uint64_t offset, size_t n, Slice *result, char *scratch) const = 0;
  };
  ...
  class LEVELDB_EXPORT EnvWrapper : public Env {
   public:
    ...
    Status
    NewSequentialFile(const std::string &f, SequentialFile **r) override {
      return target_->NewSequentialFile(f, r);
    }

    Status
    NewRandomAccessFile(const std::string &f, RandomAccessFile **r) override {
    ...
    Status
    GetChildren(const std::string &dir, std::vector<std::string> *r) override {
    ...
    std::thread *Schedule(void (*f)(void *), void *a) override {
