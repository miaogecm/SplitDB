...
namespace pmem {
  ...
  namespace detail {
    ...
    /**
     * Type trait to determine if a given parameter type satisfies requirements
     * of OutputIterator.
     */
    template <typename T>
    struct is_output_iterator : public has_iterator_category_convertible_to<
                                  T, std::output_iterator_tag> {};
     ...
     */
    template <typename T>
    struct is_forward_iterator : public has_iterator_category_convertible_to<
