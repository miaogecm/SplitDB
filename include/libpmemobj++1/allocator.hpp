...
namespace pmem {
  ...
  namespace obj {
     ...
     * @ingroup allocation
     */
    template <> class object_traits<void> {
     public:
      /*
       * Important typedefs.
       */
       ...
       * Type converting constructor.
       */
      template <typename U> explicit object_traits(object_traits<U> const &) {}
    };
     ...
     * @ingroup allocation
     */
    template <typename T> class standard_alloc_policy {
     public:
      /*
       * Important typedefs.
       */
     ...
     * @ingroup allocation
     */
    template <> class standard_alloc_policy<void> {
     public:
      /*
       * Important typedefs.
       */
    ...
    /**
     * Determines if memory from another allocator can be deallocated from this
     * one.
     *
     * @return true.
     ...
     * memory allocation model using PMDK's libpmemobj. This information
     * includes the knowledge of the pointer type, their difference type, the
     * type of the size of objects in this allocation model as well as memory
