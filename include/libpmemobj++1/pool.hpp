...
namespace pmem {
  ...
  namespace obj {
    ...
    class pool_base {
     public:
      ...
      void close() {
        ...
        auto *user_data =
          static_cast<detail::pool_data *>(pmemobj_get_user_data(this->pop));
       ...
       */
      template <typename Y> void persist(const p<Y> &prop) noexcept {
       ...
       * @param[in] prop Resides on pmem property
       */
      template <typename Y> void flush(const p<Y> &prop) noexcept {
       ...
       * @param[in] ptr Persistent pointer to object
       */
      template <typename Y> void flush(const persistent_ptr<Y> &ptr) noexcept {
      ...
      pobj_defrag_result defrag(persistent_ptr_base **ptrv, size_t oidcnt) {
        ...
        int ret = pmemobj_defrag(this->pop, (PMEMoid **)ptrv, oidcnt, &result);
     ...
     protected:
      static void check_pool(pmemobjpool *pop, std::string mode) {
        if(pop == nullptr) {
          ...
          if(errno == EINVAL || errno == EFBIG || errno == ENOENT ||
             errno == EEXIST) {
            throw detail::exception_with_errormsg<pmem::pool_invalid_argument>(
              msg);
          } else {
            throw detail::exception_with_errormsg<pmem::pool_error>(msg);
          }
        }
      }
     ...
     * @ingroup primitives
     */
    template <typename T> class pool : public pool_base {
     public:
      /**
       * Defaulted constructor.
       */
       ...
       */
      template <typename M> M ctl_get(const std::string &name) {
       ...
       * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
       */
      template <typename M> M ctl_set(const std::string &name, M arg) {
       ...
       * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
       */
      template <typename M> M ctl_exec(const std::string &name, M arg) {
       ...
       * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
       */
      template <typename M> M ctl_get(const std::wstring &name) {
        return ctl_get_detail<M>(pop, name);
      }
       ...
       * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
       */
      template <typename M> M ctl_set(const std::wstring &name, M arg) {
        return ctl_set_detail(pop, name, arg);
      }
       ...
       * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
       */
      template <typename M> M ctl_exec(const std::wstring &name, M arg) {
        return ctl_exec_detail(pop, name, arg);
      }
#endif
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_get(const std::string &name) {
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_set(const std::string &name, T arg) {
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_exec(const std::string &name, T arg) {
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_get(const std::wstring &name) {
      return ctl_get_detail<T>(nullptr, name);
    }
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_set(const std::wstring &name, T arg) {
      return ctl_set_detail(nullptr, name, arg);
    }
     ...
     * https://pmem.io/pmdk/manpages/linux/master/libpmemobj/pmemobj_ctl_get.3
     */
    template <typename T> T ctl_exec(const std::wstring &name, T arg) {
      return ctl_exec_detail(nullptr, name, arg);
    }
#endif
