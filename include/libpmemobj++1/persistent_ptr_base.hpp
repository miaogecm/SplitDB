...
namespace pmem {
  ...
  namespace obj {
     ...
     *
     * Implements some of the functionality of the persistent_ptr class. It
     * defines all applicable conversions from and to a persistent_ptr_base.
     *
     ...
     * to whatever type), but it can be used when you want to have pointer to
     * some unspecified persistent_ptr (with persistent_ptr<void> it can't be
     * done, because: persistent_ptr<T>* does not convert to
     * persistent_ptr<void>*).
     */
