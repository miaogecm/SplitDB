...
namespace pmem {
  ...
  namespace obj {
    ...
    namespace experimental {
       ...
       * defines all applicable conversions from and to a
       ...
       * self_relative_ptr<void> it can't be done, because:
       * self_relative_ptr<T>* does not convert to self_relative_ptr<void>*).
       */
