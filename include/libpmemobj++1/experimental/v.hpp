...
namespace pmem {
  ...
  namespace obj {
    ...
    namespace experimental {
       ...
       * This class ensures that the enclosed type is always properly
       * initialized by always calling the class default constructor exactly
      ...
      template <typename T> class v {
       public:
         ...
         */
        template <typename... Args> T &get(Args &&...args) noexcept {
       ...
       * @relates v
       */
      template <class T> inline void swap(v<T> &a, v<T> &b) { a.swap(b); }
