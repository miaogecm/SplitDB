...
namespace pmem {
  ...
  namespace obj {
     ...
     *
     * Constructor parameters are passed through variadic parameters. Do *NOT*
     * use this inside transactions, as it might lead to undefined behavior in
     * the presence of transaction aborts.
     *
     ...
     * cleanup must be performed elsewhere.  Do *NOT* use this inside
     * transactions, as it might lead to undefined behavior in the presence of
     * transaction aborts.
     *
