...
namespace pmem {
  ...
  namespace obj {
    ...
    constexpr inline basic_string_view<CharT,
     ...
     * view. This character acts as a placeholder, attempting to access it
    ...
    /**
     * Returns a reverse_iterator to the character following the last character
     * of the view (reverse beginning). Reverse iterators iterate backwards:
     * increasing them moves them towards the beginning of the string.
     *
     ...
     */
    template <typename CharT, typename Traits>
    inline const CharT &basic_string_view<CharT, Traits>::at(size_t pos) const {
      if(pos >= size())
     ...
     */
    template <typename CharT, typename Traits>
    void basic_string_view<CharT, Traits>::remove_prefix(size_type n) {
      data_ += n;
      size_ -= n;
    }
     ...
     */
    template <typename CharT, typename Traits>
    void basic_string_view<CharT, Traits>::remove_suffix(size_type n) {
      size_ -= n;
    }
     ...
     */
    template <typename CharT, typename Traits>
    void basic_string_view<CharT, Traits>::swap(
    ...
    template <typename CharT, typename Traits>
    typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find(CharT ch,
                                           size_type pos) const noexcept {
    ...
    template <typename CharT, typename Traits>
    typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::find(const CharT *s,
                                           size_type pos) const {
    ...
    template <typename CharT, typename Traits>
    typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::rfind(const CharT *s,
                                            size_type pos) const {
    ...
    template <typename CharT, typename Traits>
    typename basic_string_view<CharT, Traits>::size_type
    basic_string_view<CharT, Traits>::rfind(CharT ch,
                                            size_type pos) const noexcept {
    ...
    basic_string_view<CharT, Traits>::find_first_of(
      basic_string_view str, size_type pos) const noexcept {
    ...
    basic_string_view<CharT, Traits>::substr(size_type pos,
                                             size_type count) const {
      return pos > size() ? throw std::out_of_range("string_view::substr")
     ...
     * if this view is greater than the other character sequence.
     */
    template <typename CharT, typename Traits>
    inline int
     ...
     * @param[in] pos1 position of the first character in this view to compare
     * @param[in] n1 number of characters of this view to compare
     * @param[in] pos2 position of the first character of the given view to
     * compare
    ...
    inline int basic_string_view<CharT, Traits>::compare(
      const basic_string_view &other) const noexcept {
      int ret =
