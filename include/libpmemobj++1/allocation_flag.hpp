...
#ifndef LEVELDB_INCLUDE_LIBPMEMOBJ_ALLOCATION_FLAG_HPP_
#define LEVELDB_INCLUDE_LIBPMEMOBJ_ALLOCATION_FLAG_HPP_
...
#endif /* LEVELDB_INCLUDE_LIBPMEMOBJ_ALLOCATION_FLAG_HPP_ */
