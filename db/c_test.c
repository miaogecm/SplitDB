...
static void
CheckIter(leveldb_iterator_t *iter, const char *key, const char *val) {
  size_t len;
  const char *str;
...
static void
CheckPut(void *ptr, const char *k, size_t klen, const char *v, size_t vlen) {
  int *state = (int *)ptr;
...
static int
CmpCompare(void *arg, const char *a, size_t alen, const char *b, size_t blen) {
