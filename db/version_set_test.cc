...
namespace leveldb {
  ...
  class FindFileTest : public testing::Test {
   public:
    ...
    void
    Add(const char *smallest, const char *largest,
        SequenceNumber smallest_seq = 100, SequenceNumber largest_seq = 100) {
      FileMetaData *f = new FileMetaData;
      f->number = files_.size() + 1;
      f->smallest = InternalKey(Slice{smallest}, smallest_seq, kTypeValue);
      f->largest = InternalKey(Slice{largest}, largest_seq, kTypeValue);
      files_.push_back(f);
    }

    int Find(const char *key) {
      InternalKey target(Slice{key}, 100, kTypeValue);
  ...
  TEST_F(AddBoundaryInputsTest, TestEmptyLevelFiles) {
    FileMetaData *f1 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"100"}, 1, kTypeValue)));
  ...
  TEST_F(AddBoundaryInputsTest, TestNoBoundaryFiles) {
    FileMetaData *f1 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"100"}, 1, kTypeValue)));
    FileMetaData *f2 =
      CreateFileMetaData(1, InternalKey(Slice{"200"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"200"}, 1, kTypeValue)));
    FileMetaData *f3 =
      CreateFileMetaData(1, InternalKey(Slice{"300"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"300"}, 1, kTypeValue)));
  ...
  TEST_F(AddBoundaryInputsTest, TestOneBoundaryFiles) {
    FileMetaData *f1 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 3, kTypeValue),
                         InternalKey(InternalKey(Slice{"100"}, 2, kTypeValue)));
    FileMetaData *f2 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 1, kTypeValue),
                         InternalKey(InternalKey(Slice{"200"}, 3, kTypeValue)));
    FileMetaData *f3 =
      CreateFileMetaData(1, InternalKey(Slice{"300"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"300"}, 1, kTypeValue)));
  ...
  TEST_F(AddBoundaryInputsTest, TestTwoBoundaryFiles) {
    FileMetaData *f1 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 6, kTypeValue),
                         InternalKey(InternalKey(Slice{"100"}, 5, kTypeValue)));
    FileMetaData *f2 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 2, kTypeValue),
                         InternalKey(InternalKey(Slice{"300"}, 1, kTypeValue)));
    FileMetaData *f3 =
      CreateFileMetaData(1, InternalKey(Slice{"100"}, 4, kTypeValue),
                         InternalKey(InternalKey(Slice{"100"}, 3, kTypeValue)));
